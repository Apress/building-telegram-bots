...
/* Command for C compiler:
   clang -c  -w  -I/Users/niko/projects/homebrew/Cellar/nim/0.18.0_1/nim/lib -o /Users/niko/Dropbox/BOOKS2/APRESS/02-nim/nimcache/stdlib_strutils.o /Users/niko/Dropbox/BOOKS2/APRESS/02-nim/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_24, "invalid float: ", 15);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_25, "0123456789ABCDEF", 16);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_26, "invalid enum value: ", 20);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_30, "\\x", 2);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_31, "\\\\", 2);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_32, "\\\'", 2);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_33, "\\\"", 2);
...
appendString(T7_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_24));
appendString(T7_, s);
		asgnRefNoCycle((void**) (&(*e).Sup.message), T7_);
		asgnRef((void**) (&(*e).Sup.parent), NIM_NIL);
		raiseException((Exception*)e, "ValueError");
	...
	result = mnewString(((NI) (len)));
	{
		...
		res = colontmp_;
		{
			while (1) {
				...
				j = res;
				result->data[j] = ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_25)->data[(NI64)(n & IL64(15))];
...
appendString(T9_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_26));
appendString(T9_, s);
...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(230, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_28 = subInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_28), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToUpperAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_27 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_27);
		nimln_(2045, "system.nim");
		res = ((NI) 0);
		{
			nimln_(2046, "system.nim");
...
static N_INLINE(void, addEscapedChar_idr49a9aRlvTkf40D5KCA29bgsystem)(NimStringDesc** s, NIM_CHAR c) {
	...
	case 127 ... 255:
	{
		...
		(*s) = resizeString((*s), 2);
appendString((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_30));
		nimln_(3935, "system.nim");
		n = ((NU8)(c));
		nimln_(3936, "system.nim");
		if ((NU)((NI)((NU64)((NI)(n & ((NI) 240))) >> (NU64)(((NI) 4)))) > (NU)(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_25)->Sup.len)) raiseIndexError();
		(*s) = addChar((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_25)->data[(NI)((NU64)((NI)(n & ((NI) 240))) >> (NU64)(((NI) 4)))]);
		nimln_(3937, "system.nim");
		if ((NU)((NI)(n & ((NI) 15))) > (NU)(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_25)->Sup.len)) raiseIndexError();
		(*s) = addChar((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_25)->data[(NI)(n & ((NI) 15))]);
	}
	break;
	case 92:
	{
		...
		(*s) = resizeString((*s), 2);
appendString((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_31));
	}
	break;
	case 39:
	{
		...
		(*s) = resizeString((*s), 2);
appendString((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_32));
	}
	break;
	case 34:
	{
		...
		(*s) = resizeString((*s), 2);
appendString((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_33));
	}
	break;
	default:
	{
...
{	nimln_(2425, "strutils.nim");
	...
	last = ((*s) ? ((*s)->Sup.len-1) : -1);
	{
		...
		while (1) {
			...
			LA8_: ;
			if (!T7_) goto LA6;
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_34 = subInt(last, ((NI) 1));
			last = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_34);
		} LA6: ;
	}
	nimln_(2428, "strutils.nim");
	TM_JGc9b9bh2D3nTdUR7TGyq8aA_35 = addInt(last, ((NI) 1));
	(*s) = setLengthStr((*s), ((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_35), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}BeforeRet_: ;
	popFrame();
}

N_LIB_PRIVATE N_NIMCALL(void, nsuRemoveSuffixChar)(NimStringDesc** s, NIM_CHAR c) {
	tySet_tyChar_nmiMWKVIe46vacnhAFrQvw T1_;
	nimfr_("removeSuffix", "strutils.nim");
	nimln_(2443, "strutils.nim");
	memset(T1_, 0, sizeof(T1_));
	T1_[(NU)(((NU8)(c)))>>3] |=(1U<<((NU)(((NU8)(c)))&7U));
	nsuRemoveSuffixCharSet(s, T1_);
	popFrame();
}
